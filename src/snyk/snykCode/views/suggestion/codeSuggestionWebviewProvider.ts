        ...
        <div class="tab-content is-selected sn-fix-content">
              ...
              <div class="sn-loading is-hidden">
                ...
                <div class="sn-loading-wrapper">
                  <div class="sn-loading-message sn-msg-1">
                    <span class="sn-loading-title">1/4 Code Reduction</span>
                  ...
                  <div class="sn-loading-message sn-msg-2">
                    <span class="sn-loading-title">2/4 Parsing</span>
                  ...
                  <div class="sn-loading-message sn-msg-3">
                    <span class="sn-loading-title">3/4 Static Analysis</span>
                  ...
                  <div class="sn-loading-message sn-msg-4">
                    <span class="sn-loading-title">4/4 NN Inferencing</span>
          ...
          <section class="sn-ai-fixes is-hidden">
            <p id="info-top" class="font-light">
              This type of <span class="issue-type">vulnerability</span> can be fixed by our AI. Here are <span id="diff-number"></span> diffs:
            </p>
            ...
            <div id="diff"></div>
            <button class="button">Apply AI Fix</button>
          </section>
