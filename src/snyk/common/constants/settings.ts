...
export const OSS_ENABLED_SETTING = `${CONFIGURATION_IDENTIFIER}.features.oss`;
...
export const ADVANCED_AUTOSCAN_OSS_SETTING = `${CONFIGURATION_IDENTIFIER}.advanced.autoScanOss`;
