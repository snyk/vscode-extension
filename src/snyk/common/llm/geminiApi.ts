import { CancellationToken, Disposable, MarkdownString, ThemeIcon, Uri } from 'vscode';
...
export interface GeminiCodeAssist extends Disposable {
   ...
   * contain a dark and light icon or be a ThemeIcon type.
...
export interface GeminiTool extends Disposable {
   ...
   * Code Assist.
   */
  registerSuggestedPromptProvider(provider: SuggestedPromptProvider): Disposable;
}
...
export interface ChatHandler {
   ...
   * reference parts.
   */
  (request: ChatRequest, responseStream: ChatResponseStream, token: CancellationToken): Promise<void>;
}
...
export interface VariableProvider {
   ...
   */
  typeahead(part: string, limit: number, token: CancellationToken): Promise<Variable[]>;
}
...
export interface ChatResponseStream {
   ...
   */
  addCodeHandlerButton(title: string, handler: CodeHandler, options: HandlerButtonOptions): void;
}
