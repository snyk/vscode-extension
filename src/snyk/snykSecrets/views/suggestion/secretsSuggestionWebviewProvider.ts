...
export class SecretsSuggestionWebviewProvider
  extends WebviewProvider<Issue<SecretIssueData>>
  implements IWebViewProvider<Issue<SecretIssueData>>
{
  private issue: Issue<SecretIssueData> | undefined;
  ...
  async showPanel(issue: Issue<SecretIssueData>): Promise<void> {
    try {
